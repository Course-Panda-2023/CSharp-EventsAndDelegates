...
namespace DirectoryWatcherNameSpace
{
    ...
    internal class DirectoryWatcher:IDirectoryWatcher
    {
        ...
        public DirectoryWatcher (string path ,retFiles r )
        {
            printAllFiles= r;
        ...
        public DirectoryWatcher(string path, retFiles r,string filter)
        {
            printAllFiles = r;
            this.directoryPath = path;
        ...
        public void OnDirectoryChanged(object sender, FileSystemEventArgs e)
        {
